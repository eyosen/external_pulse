...
public class SolidLineRenderer extends Renderer {
    ...
    public void onFFTUpdate(byte[] fft) {
        ...
        for (int i = 0; i < (mCenterMirrored ? (mUnits / 2) : mUnits); i++) {
    ...
    private class CMRendererObserver extends ContentObserver {
        ...
        void register() {
            ...
            resolver.registerContentObserver(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(
                    Settings.Secure.getUriFor(Settings.Secure.PULSE_CENTER_MIRRORED), false,
                    this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(
        ...
        public void updateSettings() {
            ...
            mCenterMirrored = Settings.Secure.getIntForUser(resolver,
                    Settings.Secure.PULSE_CENTER_MIRRORED, 0, UserHandle.USER_CURRENT) == 1;
